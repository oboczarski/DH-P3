...
const DATAHUB_TABLE_TABLER_ICON_MARKUP = Object.freeze({
  ...
  Award: '<circle cx="12" cy="8" r="4" /><path d="M10 12l-1 7l3 -2l3 2l-1 -7" />',
  Tag: '<path d="M7 7h.01" /><path d="M3 12v-3a2 2 0 0 1 2 -2h4l9 9l-6 6l-9 -9z" />',
  Pennant: '<path d="M5 21v-16" /><path d="M5 5h11l-2.5 4l2.5 4h-11z" />',
  ...
  School: '<path d="M3 10l9 -5l9 5" /><path d="M5 10v8h14v-8" /><path d="M9 14h.01" /><path d="M15 14h.01" /><path d="M10 18v-4h4v4" />',
  Activity: '<path d="M3 12h4l3 7l4 -14l3 7h4" />',
  CirclePlay: '<circle cx="12" cy="12" r="9" /><path d="M10 9l5 3l-5 3z" />',
  InfoCircle: '<circle cx="12" cy="12" r="9" /><path d="M12 8h.01" /><path d="M12 11v5" />',
  Send: '<path d="M4 12l15 -7l-4 14l-3 -5l-8 -2z" />',
  ...
  ReportCard: '<rect x="6" y="4" width="12" height="16" rx="2" /><path d="M9 8h6" /><path d="M9 12h4" /><path d="M10 16l2 2l4 -4" />',
  ...
  Burst: '<path d="M12 4l1.8 4.2L18 10l-4.2 1.8L12 16l-1.8 -4.2L6 10l4.2 -1.8z" />',
  ...
  CircleBolt: '<circle cx="12" cy="12" r="9" /><path d="M13 7l-3 5h3l-1 5l4 -6h-3l1 -4z" />',
  ...
  LayoutColumns: '<rect x="4" y="5" width="4" height="14" rx="1" /><rect x="10" y="5" width="4" height="14" rx="1" /><rect x="16" y="5" width="4" height="14" rx="1" />',
  ChartLine: '<path d="M4 19h16" /><path d="M4 19v-14" /><path d="M7 14l4 -4l3 3l5 -6" />',
  BarMeasure: '<path d="M5 18h14" /><path d="M8 18v-5" /><path d="M12 18v-9" /><path d="M16 18v-3" />',
  Shield: '<path d="M12 3l7 4v5c0 5 -3.5 7.5 -7 9c-3.5 -1.5 -7 -4 -7 -9v-5l7 -4z" />',
  ShieldX: '<path d="M12 3l7 4v5c0 5 -3.5 7.5 -7 9c-3.5 -1.5 -7 -4 -7 -9v-5l7 -4z" /><path d="M9 9l6 6" /><path d="M15 9l-6 6" />',
  ...
  Radar: '<path d="M19.07 4.93a10 10 0 1 0 0 14.14" /><path d="M12 12l7.07 -7.07" /><circle cx="12" cy="12" r="2" />',
  Rotate: '<path d="M15 4.5a8 8 0 1 0 4 7.5" /><path d="M15 4v5h5" />',
  Check: '<path d="M7 12l3 3l7 -7" />',
  Football: '<path d="M6.5 7.5c3.9 -3.9 9.1 -4.8 11.6 -2.3c2.5 2.5 1.6 7.7 -2.3 11.6c-3.9 3.9 -9.1 4.8 -11.6 2.3c-2.5 -2.5 -1.6 -7.7 2.3 -11.6z" /><path d="M9 9l6 6" /><path d="M15 9l-6 6" /><path d="M11.5 7.5l1.5 1.5" /><path d="M11 15.5l1.5 1.5" />',
  ...
  Wind: '<path d="M3 8h9a2 2 0 1 0 0 -4" /><path d="M5 12h11a2 2 0 1 1 0 4" /><path d="M3 16h6" />',
  ...
  WaveSine: '<path d="M3 14c2 0 2 -4 4 -4s2 4 4 4s2 -4 4 -4s2 4 4 4s2 -4 4 -4" />',
  ...
  RouteTurn: '<circle cx="6" cy="18" r="2" /><path d="M8 18h5a4 4 0 0 0 4 -4v-5" /><path d="M13 9h5" /><path d="M15 7l3 2l-3 2" />',
  RouteMeasure: '<circle cx="6" cy="18" r="2" /><path d="M8 18h5a4 4 0 0 0 4 -4v-8" /><path d="M14 6h4" /><path d="M16 4v4" />',
  ...
  Mountain: '<path d="M4 20l6 -10l3 5l2 -3l5 8z" />',
  Star: '<path d="M12 3l2.4 5l5.6 .8l-4 3.9l.9 5.5l-4.9 -2.6l-4.9 2.6l.9 -5.5l-4 -3.9l5.6 -.8z" />',
...
const COLUMN_ICONS = {
  ...
  SNP:       DATAHUB_TABLE_TABLER_ICON_MARKUP.LayoutColumns,
  ...
  paATT:     DATAHUB_TABLE_TABLER_ICON_MARKUP.Send,
  "paATT_EFF": DATAHUB_TABLE_TABLER_ICON_MARKUP.Send,
  ...
  YPA:       DATAHUB_TABLE_TABLER_ICON_MARKUP.BarMeasure,
  ...
  "IMP/G":   DATAHUB_TABLE_TABLER_ICON_MARKUP.Star,
  pIMP:      DATAHUB_TABLE_TABLER_ICON_MARKUP.Bolt,
  "pIMP/A":  DATAHUB_TABLE_TABLER_ICON_MARKUP.CircleDot,
  "pIMP/ATT": DATAHUB_TABLE_TABLER_ICON_MARKUP.CircleDot,
  CAR:       DATAHUB_TABLE_TABLER_ICON_MARKUP.Football,
  YPC:       DATAHUB_TABLE_TABLER_ICON_MARKUP.BarMeasure,
  ...
  INT:       DATAHUB_TABLE_TABLER_ICON_MARKUP.ShieldX,
  FUM:       DATAHUB_TABLE_TABLER_ICON_MARKUP.AlertCircle,
  ...
  ELU:       DATAHUB_TABLE_TABLER_ICON_MARKUP.Wind,
  "MTF/A":   DATAHUB_TABLE_TABLER_ICON_MARKUP.CircleDot,
  "YCO/A":   DATAHUB_TABLE_TABLER_ICON_MARKUP.WaveSine,
  MTF:       DATAHUB_TABLE_TABLER_ICON_MARKUP.Gamepad,
  YCO:       DATAHUB_TABLE_TABLER_ICON_MARKUP.Burst,
  ...
  YAC:       DATAHUB_TABLE_TABLER_ICON_MARKUP.RouteTurn,
  "TS%":     DATAHUB_TABLE_TABLER_ICON_MARKUP.Percentage,
  YPRR:      DATAHUB_TABLE_TABLER_ICON_MARKUP.RouteMeasure,
  TPRR:      DATAHUB_TABLE_TABLER_ICON_MARKUP.TargetArrow,
  ...
  YPR:       DATAHUB_TABLE_TABLER_ICON_MARKUP.BarMeasure,
  ...
  tgtQBR:    DATAHUB_TABLE_TABLER_ICON_MARKUP.Radar,
...
// Stats per-category icon overrides:
// the table now carries a dedicated catch-and-run glyph for YAC across the
// Stats family, so no extra per-category swaps are currently needed.
...
// Data Hub group-icon semantics:
// separate the mixed receiving, receiving-efficiency, rushing-efficiency, and
// ceiling groups so table families stop reusing the same convenience glyphs.
const CURRENT_RECEIVING_GROUP_ICON = DATAHUB_TABLE_TABLER_ICON_MARKUP.HandGrab;
const CURRENT_RECEIVING_EFFICIENCY_GROUP_ICON = DATAHUB_TABLE_TABLER_ICON_MARKUP.RouteMeasure;
const CURRENT_ADV_RUSHING_GROUP_ICON = DATAHUB_TABLE_TABLER_ICON_MARKUP.Wind;
const CURRENT_CEILING_GROUP_ICON = DATAHUB_TABLE_TABLER_ICON_MARKUP.Mountain;
...
const BASE_COLUMN_GROUPS = Object.freeze({
  ...
  passing: Object.freeze([
    ...
    createDataHubColumnGroup({
      ...
      icon: DATAHUB_TABLE_TABLER_ICON_MARKUP.Send,
    ...
    createDataHubColumnGroup({
      label: "RUSHING",
      icon: DATAHUB_TABLE_TABLER_ICON_MARKUP.Football,
  ...
  receiving: Object.freeze([
    ...
    createDataHubColumnGroup({
      ...
      icon: CURRENT_RECEIVING_EFFICIENCY_GROUP_ICON,
...
function createRookiesProspectOverviewGroup({ formatFamily = null } = {}) {
  return createDataHubColumnGroup({
    ...
    icon: DATAHUB_TABLE_TABLER_ICON_MARKUP.ReportCard,
