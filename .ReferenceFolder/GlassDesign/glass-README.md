# glass-README provided for reference.
# IMPORTANT! DISREGARD INFO INDICATED FOR REACT FRAMEWORKS. OUR APP IS CSS-ONLY, SO REACT COMPONENTS ARE NOT APPLICABLE TO OUR USE CASE. READ ONLY THE CSS USAGE INSTRUCTIONS.
